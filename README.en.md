...
**Long-press** the **📝 notes icon button** in the top-right corner and pick:
...
| Hide/show all | tap the 📝 notes button: all notes hide at once; tap again to restore (state is remembered) |
