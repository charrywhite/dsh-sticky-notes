...
.dsn-eye{display:flex;align-items:center;justify-content:center;box-sizing:border-box;width:26px;height:26px;font-size:13px;line-height:1;background:linear-gradient(180deg,#374151,#111827);border:1px solid rgba(255,255,255,.28);border-radius:50%;box-shadow:0 6px 16px rgba(0,0,0,.35);padding:0;cursor:pointer;font-family:system-ui,-apple-system,"Segoe UI",sans-serif;transition:filter .12s;touch-action:none;pointer-events:auto}
.dsn-eye:hover{filter:brightness(1.15)}
.dsn-eye.off{opacity:.85;filter:saturate(.45)}
.dsn-eye.off:hover{filter:saturate(.45) brightness(1.2)}
