...
.dsn-home{display:block;box-sizing:border-box;font-size:13px;font-weight:600;line-height:1;color:#713f12;background:linear-gradient(180deg,#fef9c3,#fef3c7);border:1px solid rgba(180,140,40,.45);border-radius:99px;box-shadow:0 10px 24px rgba(60,40,10,.28),0 2px 6px rgba(60,40,10,.15);padding:10px 16px;cursor:pointer;font-family:system-ui,-apple-system,"Segoe UI",sans-serif;transition:filter .12s;white-space:nowrap;touch-action:none;pointer-events:auto}
