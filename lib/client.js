...
.dsn-newbox{position:absolute;right:20px;top:30px;pointer-events:auto;z-index:6;width:fit-content;height:fit-content;display:flex;flex-direction:column;align-items:center;gap:8px;user-select:none;-webkit-user-select:none}
...
.dsn-eye{display:flex;align-items:center;justify-content:center;box-sizing:border-box;width:48px;height:48px;font-size:22px;line-height:1;color:#713f12;background:linear-gradient(180deg,#fef9c3,#fef3c7);border:1px solid rgba(180,140,40,.45);border-radius:50%;box-shadow:0 10px 24px rgba(60,40,10,.28),0 2px 6px rgba(60,40,10,.15);padding:0;cursor:pointer;font-family:system-ui,-apple-system,"Segoe UI",sans-serif;transition:filter .12s;touch-action:none;pointer-events:auto}
.dsn-eye:hover{filter:brightness(.96)}
.dsn-eye:active{filter:brightness(.88)}
